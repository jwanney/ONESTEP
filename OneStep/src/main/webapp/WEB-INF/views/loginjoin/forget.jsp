...
<head>
    ...
    <title>Xato Auth Forget Password 1 | Xato - Multipurpose Bootstrap Admin Dashboard Template</title>
            ...
            <div class="row main-login-one h-100">
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 p-0">
                    <div class="login-one-start">
                        <h6 class="mt-2 text-primary text-center font-20">아이디를 잊어버리셨나요?</h6>
                        <div class="form-1" style="margin-bottom: 50px">
                            <p class="text-center text-muted mt-3 mb-3 font-14">이름과 E-mail주소를 입력하세요</p>
                            <h6 class="mt-4 text-primary  font-20">이름</h6>
                            <div class="login-one-inputs">
                                <input type="text" id="memName"  placeholder="이름을 입력하세요"/>
                                <i class="las la-envelope"></i> 
                            </div>
                            <h6 class="mt-2 text-primary  font-20">이메일</h6>
                            <div class="login-one-inputs mt-3">
                                <input type="text" id="memMail" placeholder="이메일을 입력하세요"/>
                                <i class="las la-envelope"></i> 
                            </div>
                            <div class="login-one-inputs mt-4">
                                <button class="ripple-button ripple-button-primary btn-lg btn-login" type="button" id="idBtn">
                            ...
                            <div id="idZone" style="color: green; font-size: 20px; margin-top: 20px"></div>
                        </div>
                        
                        <h6 class="mt-2 text-primary text-center font-20">비밀번호를 잊어버리셨나요?</h6>
                        <div class="form-1" style="margin-bottom: 50px">
                            <p class="text-center text-muted mt-3 mb-3 font-14">아이디와 E-mail주소를 입력하세요</p>
                            <h6 class="mt-4 text-primary  font-20">아이디</h6>
                            <div class="login-one-inputs">
                                <input type="text" id="memId" placeholder="아이디를 입력하세요"/>
                                <i class="las la-envelope"></i> 
                            </div>
                            <h6 class="mt-2 text-primary  font-20">이메일</h6>
                            <div class="login-one-inputs mt-3">
                                <input type="text" id="memMail2" placeholder="이메일을 입력하세요"/>
                                <i class="las la-envelope"></i> 
                            </div>
                            <div class="login-one-inputs mt-4">
                                <button class="ripple-button ripple-button-primary btn-lg btn-login" type="button" id="pwBtn">
                                    <div class="ripple-ripple js-ripple">
                                    <span class="ripple-ripple__circle"></span>
                                    </div>
                                    	비밀번호 찾기
			...
			$.ajax({
				url: "/member/idForget",  
				  ...
				  data: {memName : $('#memName').val(),
						 memEmail : $('#memMail').val()
					  },  
				  success: function(result) {
				      console.log(result)
				      if(result!="FAILED"){
						$('#idZone').text("회원님의 ID는 "+result+"입니다");
					      }else{
							alert('해당하는 ID를 찾을수 없습니다.');
						      }
				      }
				  ,
