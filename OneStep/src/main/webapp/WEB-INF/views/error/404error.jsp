    ...
    <div class="error-wrapper">
        <div class="col-md-6 error-left-section">
            ...
            <div class="error-left-content">
                ...
                <p class="font-25 mb-5 text-white">Sorry, We can't seem to find the page you're looking for.</p>
                <a class="btn bg-gradient-primary text-white" href="/member/login">back</a>
            </div>
        </div>
        <div class="col-md-6 error-right-section">
            <img src="${pageContext.request.contextPath }/resources/assets/img/error-404-1.png" class="error-img" />
        </div>
    </div>
    <!-- Main Body Ends -->
    <!-- Footer Starts -->
