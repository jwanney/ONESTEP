...
<head>
    ...
    <link href="${pageContext.request.contextPath }/resources/assets/css/pages/coming-soon/style.css" rel="stylesheet" type="text/css" />
...
<body class="coming-soon">   
    ...
    <div class="coming-soon-container">
        <div class="coming-soon-top">
            <img src="${pageContext.request.contextPath }/resources/assets/img/coming-soon-bg-1.png" class="coming-soon-bg"/>
            <div class="area" >
                <ul class="squares">
        ...
        <div class="coming-soon-bottom">
            ...
            <p class="mb-0 mt-3">We are currently working really hard on this page.</p>
            <p class="mb-0">Subscribe our Newsletter to get update when it'll be live</p>
        </div>
    </div>
    <!-- Main Body Ends -->
